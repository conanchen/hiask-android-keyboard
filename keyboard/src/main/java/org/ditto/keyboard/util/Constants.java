...
public class Constants {
    ...
    public static final int RC_RECORD_AUDIO_PERM = 100;
    public static final int RC_INTERNET_PERM = 101;
    public static final int RC_CAMERA_PERM = 102;
    public static final int RC_READWRITE_EXTERNAL_STORAGE_PERM = 103;
