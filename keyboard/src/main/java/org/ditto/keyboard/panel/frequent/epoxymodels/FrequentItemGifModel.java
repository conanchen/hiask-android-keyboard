 ...
 */
@EpoxyModelClass
public abstract class FrequentItemGifModel extends EpoxyModelWithHolder<FrequentItemGifModel.Holder> {
    ...
    public void bind(Holder holder) {
        ...
        holder.price.setText(String.format("%d通通币",price));
    ...
    protected int getDefaultLayout() {
        return R.layout.frequent_item_gif_model;
    }
}
