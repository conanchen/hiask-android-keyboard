 ...
 * <p/>
 */
public class AudioTalkFragment extends KeyboardPanelbaseFragment implements EasyPermissions.PermissionCallbacks {
    private final static String TAG = "AudioTalkFragment";


    @Inject
    AudioViewModelFactory viewModelFactory;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View   view = (View) inflater.inflate(R.layout.fragment_panel_audio_talk, container, false);
    ...
    private void setupController() {
        ...
        viewModel = ViewModelProviders.of(this, viewModelFactory).get(AudioViewModel.class);
...
//        });
    ...
    @AfterPermissionGranted(Constants.RC_RECORD_AUDIO_PERM)
    public void audioTask() {
        if (EasyPermissions.hasPermissions(this.getContext(), Manifest.permission.RECORD_AUDIO)) {
            ...
            EasyPermissions.requestPermissions(this, getString(R.string.rationale_audio),
                    Constants.RC_RECORD_AUDIO_PERM, Manifest.permission.RECORD_AUDIO);
        }
    }
    ...
    public static final class Builder {
        ...
        public AudioTalkFragment build() {
            String missing = "";
            ...
            AudioTalkFragment fragment = new AudioTalkFragment();
