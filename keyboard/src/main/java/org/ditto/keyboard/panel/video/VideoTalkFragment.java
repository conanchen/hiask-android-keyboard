 ...
 * <p/>
 */
public class VideoTalkFragment extends KeyboardPanelbaseFragment implements EasyPermissions.PermissionCallbacks {
    private final static String TAG = "VideoTalkFragment";
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View   view = (View) inflater.inflate(R.layout.fragment_panel_video_talk, container, false);
...
//        });
    ...
    public static final class Builder {
        ...
        public VideoTalkFragment build() {
            String missing = "";
